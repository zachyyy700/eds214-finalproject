...
Details on importing, combining, and cleaning data can be found in [`R/dataimport_cleaning.R`](https://github.com/zachyyy700/eds214-finalproject/blob/main/R/dataimport_cleaning.R)

##### **Install necessary packages to replicate this Quarto doc by seeing [`R/environ_init.R`](https://github.com/zachyyy700/eds214-finalproject/blob/main/R/environ_init.R)**
...
Two functions were created to 1. calculate the moving average of irregular observation windows (see [`R/moving_avg_function.R`](https://github.com/zachyyy700/eds214-finalproject/blob/main/R/moving_avg_function.R)) and 2. apply the moving average function over a range of columns and create new rolling average columns for each stream measurement (see [`R/zapply.R`](https://github.com/zachyyy700/eds214-finalproject/blob/main/R/zapply.R) for function creation and [`R/dataimport_cleaning.R`](https://github.com/zachyyy700/eds214-finalproject/blob/main/R/dataimport_cleaning.R) for application use.
